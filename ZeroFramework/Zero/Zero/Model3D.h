...
namespace zr
{
	...
	private:
		...
		std::string generateVertexShaderMain() const;
		std::string generateFragmentShaderUniforms() const;
		std::string generateFragmentShaderMain() const;
		...
		unsigned getMaxAttributeLength() const;
